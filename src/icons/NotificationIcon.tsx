...
export default function NotificationIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M15.3299 18.8199C15.3299 20.6499 13.8299 22.1499 11.9999 22.1499C11.0899 22.1499 10.2499 21.7699 9.64992 21.1699C9.04992 20.5699 8.66992 19.7299 8.66992 18.8199" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10"/>
    </svg>
  );
}
